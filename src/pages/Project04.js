...
function Project04() {
  return (
<section className='project' id='Project_four'>
        <h2>project<span>NETFLIX</span></h2>
        <div className='boxes'>
            <div className='leftbox'>
                ...
                <span>detail view</span>
                    <span><a href="https://seapearl98.github.io/netflix/" target={'_blank'}>visit website</a></span>
                </div>
            </div>
